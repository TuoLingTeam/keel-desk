...
if (!output.includes(`id: "${clientId}"`) || !output.includes('factory: (require)')) {
  throw new Error('dsh-attachment does not implement the Harness lazy-CJS handoff')
}

console.log(`[dsh-attachment] Built Host and browser bundles in ${outDir}`)
