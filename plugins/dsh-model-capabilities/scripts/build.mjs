...
const clientId = 'dsh-model-capability'
...
if (!output.includes(`id: "${clientId}"`) || !output.includes('factory: (require)')) {
  throw new Error('dsh-model-capability does not implement the Harness lazy-CJS handoff')
}

console.log(`[dsh-model-capability] Built Host and browser bundles in ${outDir}`)
