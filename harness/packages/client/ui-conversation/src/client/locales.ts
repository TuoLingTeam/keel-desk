...
export const zh = {
  ...
  'image.dropTitle': '拖动到此处即可添加',
  'image.dropDesc': '图片最多 {count} 张，每张 {size}',
  ...
  'find.close': '关闭搜索',
  'outline.open': '消息清单',
  'outline.title': '我发送的消息',
  'outline.empty': '还没有发送消息',
  'outline.imageOnly': '[图片]',
  'outline.loadOlder': '加载更早的消息',
  'outline.loading': '加载中…',
...
export const en = {
  ...
  'image.dropTitle': 'Drag here to add',
  'image.dropDesc': 'Images: up to {count}, {size} each',
  ...
  'find.open': 'Search conversation',
  'find.placeholder': 'Search in conversation',
  'find.count': '{index}/{total}',
  'find.none': 'No matches',
  'find.prev': 'Previous match',
  'find.next': 'Next match',
  'find.close': 'Close search',
  'outline.open': 'Message list',
  'outline.title': 'Messages you sent',
  'outline.empty': 'No messages yet',
  'outline.imageOnly': '[Image]',
  'outline.loadOlder': 'Load earlier messages',
