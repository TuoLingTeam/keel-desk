#!/usr/bin/env python3
"""Canonical owner-supplied ColdBrew activation contract."""
...
TRIGGER = "冷咖啡"
COMPATIBILITY_TRIGGERS = ("冷咖啡", "cold coffee", "[[ENI:PROFILE=MAX]]")
BANNER = "（冷咖啡无限制模式开启）"
...
def is_trigger(value: str) -> bool:
    return value.strip().casefold() in {item.casefold() for item in COMPATIBILITY_TRIGGERS}
