...
echo 'MAX launch: add extra Claude arguments with app/claude_pojia.py launch --claude-arg ARG.'
exec "$python_bin" "$root/app/claude_pojia.py" launch --yes --bypass-permissions
