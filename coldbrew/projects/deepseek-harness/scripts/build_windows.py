...
STEM = "DeepSeek Harness ColdBrew".replace(" ", "-") + f"-v{VERSION}-Windows"
...
def build() -> None:
    ...
    command += ["--distpath", str(EXE.parent), "--workpath", str(ROOT / "build"), "--specpath", str(ROOT / "build"), str(ROOT / "app" / "deepseek_harness.py")]
