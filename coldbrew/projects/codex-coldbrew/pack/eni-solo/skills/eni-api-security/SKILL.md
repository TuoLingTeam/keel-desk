...
description: "[DOCUMENTATION ONLY] [仅文档] 全局自动路由 | API 安全测试方法论：REST / GraphQL / WebSocket / SOAP，JWT / OAuth 认证测试，BOLA / BFLA 授权测试，发现到 CI/CD 集成的完整流程。"
---
